...
Cloned from https://en.wikipedia.org/wiki/Transport_Layer_Security.

Wikipedia text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

Page id: 187813.

Transport Layer Security (TLS) is a cryptographic protocol designed to provide secured communications over a computer network, such as the Internet. The protocol is widely used in applications such as email, instant messaging, and voice over IP, but its use in securing HTTPS remains the most publicly visible.
...
Older versions of TLS and SSL allowed for establishing sessions via a PreMasterSecret using the server's public and private key. These algorithms were eliminated in TLS1.3 when it mandated forward secrecy.
...
To protect against "harvest now, decrypt later" attacks by future quantum computers, hybrid post-quantum key agreement schemes have been deployed for TLS 1.3. These combine a classical ECDHE exchange with ML-KEM, the lattice-based key encapsulation mechanism standardized by NIST as FIPS 203 in August 2024. The IETF TLS working group defines the hybrid groups X25519MLKEM768, SecP256r1MLKEM768 and SecP384r1MLKEM1024 in an Internet-Draft, alongside a general framework for hybrid key exchange in TLS 1.3 and a specification for standalone (non-hybrid) ML-KEM key agreement.
X25519MLKEM768 (and its predecessor X25519Kyber768) has been enabled by default in Google Chrome since version 131 (November 2024) and Firefox since version 132, and is supported by server-side implementations including OpenSSL 3.5, BoringSSL and Cloudflare.
...
As of July 2026, there is no formal date for TLS 1.2 to be deprecated which allows for legacy clients.  However the use of MD5  and SHA1 hash methods  as well as Diffie-Hellman (DH) over a finite field and RSA key exchanges have been deprecated. (RFC 9155, 10015)


=== TLS 1.3 ===
TLS 1.3 was defined in RFC 8446 in August 2018. and updated with RFC 9846 in July 2026. It is based on the earlier TLS 1.2 specification. Major differences from TLS 1.2 include:
...
Joshua Davies (2010). Implementing SSL/TLS. Wiley. ISBN 978-0-470-92041-1.
...
Ivan Ristic (2022). Bulletproof TLS and PKI, Second Edition. Feisty Duck. ISBN 978-1-907117-09-1.
...
The current approved version of (D)TLS is version 1.3, which is specified in:
 ...
 You are invited to add it here.
RFC 9147 – "The Datagram Transport Layer Security (DTLS) Protocol Version 1.3," Proposed Standard.
The current standards replaces these former versions:

RFC 5246 – "The Transport Layer Security (TLS) Protocol Version 1.2," Obsolete.
RFC 6347 – "Datagram Transport Layer Security Version 1.2," Obsolete.
RFC 4346 – "The Transport Layer Security (TLS) Protocol Version 1.1," Historic.
RFC 2246 – "The TLS Protocol Version 1.0," Historic.
...
RFC 9367 – "GOST Cipher Suites for Transport Layer Security (TLS) Protocol Version 1.3," Informational.
Extensions to (D)TLS 1.2 include:

RFC 5288 – "AES Galois Counter Mode (GCM) Cipher Suites for TLS," Proposed Standard.
RFC 5289 – "TLS Elliptic Curve Cipher Suites with SHA-256/384 and AES Galois Counter Mode (GCM)," Proposed Standard.
RFC 5746 – "Transport Layer Security (TLS) Renegotiation Indication Extension," Proposed Standard.
RFC 5878 – "Transport Layer Security (TLS) Authorization Extensions," Experimental.
RFC 5932 – "Camellia Cipher Suites for TLS," Proposed Standard.
RFC 6066 – "Transport Layer Security (TLS) Extensions: Extension Definitions," Proposed Standard. 
RFC 6091 – "Using OpenPGP Keys for Transport Layer Security (TLS) Authentication," Informational.
RFC 6176 – "Prohibiting Secure Sockets Layer (SSL) Version 2.0," Proposed Standard.
RFC 6209 – "Addition of the ARIA Cipher Suites to Transport Layer Security (TLS)," Informational.
RFC 6347 – "Datagram Transport Layer Security Version 1.2," Obsolete. 
RFC 6367 – "Addition of the Camellia Cipher Suites to Transport Layer Security (TLS)," Informational.
RFC 6460 – "Suite B Profile for Transport Layer Security (TLS)," Historic. 
RFC 6655 – "AES-CCM Cipher Suites for Transport Layer Security (TLS)," Proposed Standard.
RFC 7027 – "Elliptic Curve Cryptography (ECC) Brainpool Curves for Transport Layer Security (TLS)," Informational.
RFC 7251 – "AES-CCM Elliptic Curve Cryptography (ECC) Cipher Suites for TLS," Informational.
RFC 7301 – "Transport Layer Security (TLS) Application-Layer Protocol Negotiation Extension," Proposed Standard.
RFC 7366 – "Encrypt-then-MAC for Transport Layer Security (TLS) and Datagram Transport Layer Security (DTLS)," Proposed Standard.
RFC 7465 – "Prohibiting RC4 Cipher Suites," Proposed Standard.
RFC 7507 – "TLS Fallback Signaling Cipher Suite Value (SCSV) for Preventing Protocol Downgrade Attacks," Obsolete.
RFC 7568 – "Deprecating Secure Sockets Layer Version 3.0," Proposed Standard.
RFC 7627 – "Transport Layer Security (TLS) Session Hash and Extended Master Secret Extension," Proposed Standard.
RFC 7685 – "A Transport Layer Security (TLS) ClientHello Padding Extension," Proposed Standard.
RFC 8422 – "Elliptic Curve Cryptography (ECC) Cipher Suites for Transport Layer Security (TLS) Versions 1.2 and Earlier," Proposed Standard.
RFC 9189 – "GOST Cipher Suites for Transport Layer Security (TLS) Protocol Version 1.2," Informational.
Extensions to (D)TLS 1.1 include:

RFC 4366 – "Transport Layer Security (TLS) Extensions," Obsolete. 
RFC 4492 – "Elliptic Curve Cryptography (ECC) Cipher Suites for Transport Layer Security (TLS)," Obsolete.
RFC 4680 – "TLS Handshake Message for Supplemental Data," Proposed Standard.
RFC 4681 – "TLS User Mapping Extension," Proposed Standard.
RFC 4785 – "Pre-Shared Key (PSK) Ciphersuites with NULL Encryption for Transport Layer Security (TLS)," Proposed Standard.
RFC 5054 – "Using the Secure Remote Password (SRP) Protocol for TLS Authentication," Informational. 
RFC 5077 – "Transport Layer Security (TLS) Session Resumption without Server-Side State," Obsolete.
RFC 5081 – "Using OpenPGP Keys for Transport Layer Security (TLS) Authentication," Experimental.
RFC 5216 – "The EAP-TLS Authentication Protocol," Proposed Standard.
Extensions to TLS 1.0 include:

RFC 2595 – "Using TLS with IMAP, POP3 and ACAP," Proposed Standard. 
RFC 2712 – "Addition of Kerberos Cipher Suites to Transport Layer Security (TLS)," Proposed Standard. 
RFC 2817 – "Upgrading to TLS Within HTTP/1.1," Proposed Standard. 
RFC 2818 – "HTTP Over TLS," Obsolete. 
RFC 3207 – "SMTP Service Extension for Secure SMTP over Transport Layer Security," Proposed Standard. 
RFC 3268 – "Advanced Encryption Standard (AES) Ciphersuites for Transport Layer Security (TLS)," Obsolete. 
RFC 3546 – "Transport Layer Security (TLS) Extensions," Obsolete. 
RFC 3749 – "Transport Layer Security Protocol Compression Methods," Proposed Standard. 
RFC 3943 – "Transport Layer Security (TLS) Protocol Compression Using Lempel-Ziv-Stac (LZS)," Informational.
RFC 4132 – "Addition of Camellia Cipher Suites to Transport Layer Security (TLS)," Obsolete.
RFC 4162 – "Addition of SEED Cipher Suites to Transport Layer Security (TLS)," Proposed Standard.
RFC 4217 – "Securing FTP with TLS," Proposed Standard.
RFC 4279 – "Pre-Shared Key Ciphersuites for Transport Layer Security (TLS)," Proposed Standard. 


=== Informational RFCs ===
RFC 7457 – "Summarizing Known Attacks on Transport Layer Security (TLS) and Datagram TLS (DTLS)," Informational.
RFC 9325 – "Recommendations for Secure Use of Transport Layer Security (TLS) and Datagram Transport Layer Security (DTLS)," Best Current Practice 195.
