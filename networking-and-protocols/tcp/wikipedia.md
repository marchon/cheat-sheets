...
Cloned from https://en.wikipedia.org/wiki/Transmission_Control_Protocol.
...
TCP was standardized in January 1980 as RFC 761. About 315 Internet hosts advertised TCP support by 1983, with only a portion accepting connections at any given time.
...
A RFC draft proposes a new use for this bit. The bit is now used for negotiating the use of Accurate ECN.
Flags: 8 bits
...
A TCP connection is managed by an operating system through a resource that represents the local endpoint for communications, the Internet socket. During the lifetime of a TCP connection, the local endpoint undergoes a series of state changes:
...
TCP Cookie Transactions (TCPCT) is an extension proposed in December 2009 to secure servers against denial-of-service attacks. Unlike SYN cookies, TCPCT does not conflict with other TCP extensions such as window scaling. TCPCT was designed due to the necessities of DNSSEC, where servers have to handle large numbers of short-lived TCP connections. In 2016, TCPCT was deprecated in favor of TCP Fast Open. The status of the original RFC was changed to historic.


== Hardware implementations ==
One way to overcome the processing power requirements of TCP is to build hardware implementations of it, widely known as TCP offload engines (TOEs). The main problem of TOEs is that they are hard to integrate into computing systems, requiring extensive changes in the operating system of the computer or device.
...
Since TCP is a rate-adaptive protocol, the rate at which the TCP sender injects packets into the network is directly proportional to the prevailing load condition within the network as well as the processing capacity of the receiver. The prevailing conditions within the network are judged by the sender on the basis of the acknowledgments received by it. The acceleration node splits the feedback loop between the sender and the receiver and thus guarantees a shorter round trip time (RTT) per packet. A shorter RTT is beneficial as it ensures a quicker response time to any changes in the network and a faster adaptation by the sender to combat these changes.
...
Cerf, Vint; Dalal, Yogen; Sunshine, Carl (December 1974). Specification of Internet Transmission Control Program, December 1974 Version. IETF. doi:10.17487/RFC0675. RFC 675.
Postel, Jon (September 1981). Internet Protocol. IETF. doi:10.17487/RFC0791. RFC 791.
Postel, Jon (September 1981). Transmission Control Protocol. IETF. doi:10.17487/RFC0793. RFC 793.
Braden, Robert, ed. (October 1989). Requirements for Internet Hosts – Communication Layers. IETF. doi:10.17487/RFC1122. RFC 1122.
Jacobson, Van; Braden, Bob; Borman, Dave (May 1992). TCP Extensions for High Performance. IETF. doi:10.17487/RFC1323. RFC 1323.
Bellovin, Steven M. (May 1996). Defending Against Sequence Number Attacks. IETF. doi:10.17487/RFC1948. RFC 1948.
Mathis, Matt; Mahdavi, Jamshid; Floyd, Sally; Romanow, Allyn (October 1996). TCP Selective Acknowledgment Options. IETF. doi:10.17487/RFC2018. RFC 2018.
Allman, Mark; Paxson, Vern; Stevens, W. Richard (April 1999). TCP Congestion Control. IETF. doi:10.17487/RFC2581. RFC 2581.
Floyd, Sally; Mahdavi, Jamshid; Mathis, Matt; Podolsky, Matthew (July 2000). An Extension to the Selective Acknowledgement (SACK) Option for TCP. IETF. doi:10.17487/RFC2883. RFC 2883.
Ramakrishnan, K. K.; Floyd, Sally; Black, David (September 2001). The Addition of Explicit Congestion Notification (ECN) to IP. IETF. doi:10.17487/RFC3168. RFC 3168.
Ludwig, Reiner; Meyer, Michael (April 2003). The Eifel Detection Algorithm for TCP. IETF. doi:10.17487/RFC3522. RFC 3522.
Spring, Neil; Weatherall, David; Ely, David (June 2003). Robust Explicit Congestion Notification (ECN) Signaling with Nonces. IETF. doi:10.17487/RFC3540. RFC 3540.
Allman, Mark; Paxson, Vern; Blanton, Ethan (September 2009). TCP Congestion Control. IETF. doi:10.17487/RFC5681. RFC 5681.
Simpson, William Allen (January 2011). TCP Cookie Transactions (TCPCT). IETF. doi:10.17487/RFC6013. RFC 6013.
Ford, Alan; Raiciu, Costin; Handley, Mark; Barre, Sebastien; Iyengar, Janardhan (March 2011). Architectural Guidelines for Multipath TCP Development. IETF. doi:10.17487/RFC6182. RFC 6182.
Paxson, Vern; Allman, Mark; Chu, H.K. Jerry; Sargent, Matt (June 2011). Computing TCP's Retransmission Timer. IETF. doi:10.17487/RFC6298. RFC 6298.
Ford, Alan; Raiciu, Costin; Handley, Mark; Bonaventure, Olivier (January 2013). TCP Extensions for Multipath Operation with Multiple Addresses. IETF. doi:10.17487/RFC6824. RFC 6824.
Mathis, Matt; Dukkipati, Nandita; Cheng, Yuchung (May 2013). Proportional Rate Reduction for TCP. IETF. doi:10.17487/RFC6937. RFC 6937.
Borman, David; Braden, Bob; Jacobson, Van (September 2014). Scheffenegger, Richard (ed.). TCP Extensions for High Performance. IETF. doi:10.17487/RFC7323. RFC 7323.
Duke, Martin; Braden, Robert; Eddy, Wesley M.; Blanton, Ethan; Zimmermann, Alexander (February 2015). A Roadmap for Transmission Control Protocol (TCP) Specification Documents. IETF. doi:10.17487/RFC7414. RFC 7414.
Cheng, Yuchung; Chu, Jerry; Radhakrishnan, Sivasankar; Jain, Arvind (December 2014). TCP Fast Open. IETF. doi:10.17487/RFC7413. RFC 7413.
Zimmermann, Alexander; Eddy, Wesley M.; Eggert, Lars (April 2016). Moving Outdated TCP Extensions and TCP-Related Documents to Historic or Informational Status. IETF. doi:10.17487/RFC7805. RFC 7805.
Fairhurst, Gorry; Trammell, Brian; Kuehlewind, Mirja, eds. (March 2017). Services Provided by IETF Transport Protocols and Congestion Control Mechanisms. IETF. doi:10.17487/RFC8095. RFC 8095.
Cheng, Yuchung; Cardwell, Neal; Dukkipati, Nandita; Jha, Priyaranjan, eds. (February 2021). The RACK-TLP Loss Detection Algorithm for TCP. IETF. doi:10.17487/RFC8985. RFC 8985.
Deering, Stephen E.; Hinden, Robert M. (July 2017). Internet Protocol, Version 6 (IPv6) Specification. IETF. doi:10.17487/RFC8200. RFC 8200.
...
Iyengar, Jana; Swett, Ian, eds. (May 2021). QUIC Loss Detection and Congestion Control. IETF. doi:10.17487/RFC9002. RFC 9002.
...
Eddy, Wesley M., ed. (August 2022). Transmission Control Protocol (TCP). IETF. doi:10.17487/RFC9293. RFC 9293.
...
Ludwig, Reiner; Katz, Randy Howard (January 2000). "The Eifel algorithm: making TCP robust against spurious retransmissions". ACM SIGCOMM Computer Communication Review. 30: 30–36. doi:10.1145/505688.505692.
...
IANA TCP Parameters
Archived 2021-02-14 at the Wayback Machine
