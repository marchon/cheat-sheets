...
TLDR page cloned from https://www.cheat-sheets.org/project/tldr/command/tailscale-up/.
...
In version 1.8 and above, command line arguments are stored and reused until they're overwritten or
--reset
is called.
More information:
https://tailscale.com/kb/admin/
.
