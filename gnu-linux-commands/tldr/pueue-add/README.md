...
TLDR page cloned from https://www.cheat-sheets.org/project/tldr/command/pueue-add/.
...
Add a command to a group and start it immediately, see
pueue group
to manage groups:
...
Add a command with a label after some delay has passed, see
pueue enqueue
