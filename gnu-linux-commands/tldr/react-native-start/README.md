...
TLDR page cloned from https://www.cheat-sheets.org/project/tldr/command/react-native-start/.
...
More information:
https://github.com/react-native-community/cli/blob/master/docs/commands.md#start
.
