...
TLDR page cloned from https://www.cheat-sheets.org/project/tldr/command/borg/.
...
Extract a specific directory from the "Monday" archive in a remote repository, excluding all
*.ext
files:
