...
TLDR page cloned from https://www.cheat-sheets.org/project/tldr/command/bq/.
...
.
Run query against a BigQuery table using standard SQL, add
--dry_run
flag to estimate the number of bytes read by the query:
