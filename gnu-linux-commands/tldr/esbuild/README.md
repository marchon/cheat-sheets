...
TLDR page cloned from https://www.cheat-sheets.org/project/tldr/command/esbuild/.
...
Bundle and minify a JSX application with source maps in
production
mode:
...
Bundle a JavaScript application enabling JSX syntax in
.js
files:
