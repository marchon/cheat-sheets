...
Cloned from https://en.wikipedia.org/wiki/Less_(Unix).
...
less(1) – FreeBSD General Commands Manual
less(1) – Linux User Manual – User Commands from Manned.org
less(1) – Debian General Commands Manual
lesspipe.sh webpage
