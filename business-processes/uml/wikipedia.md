...
Cloned from https://en.wikipedia.org/wiki/Unified_Modeling_Language.
...
An artifact
is the "specification of a physical piece of information that is used or produced by a software development process, or by deployment and operation of a system" including models, source code, scripts, executables, tables in database systems, development deliverables, design documents, and email messages.
...
C4 model – Technique for modelling software architecture
...
Model-based testing – Application of model-based design
Model-driven engineering – Software development methodology
Modeling and Analysis of Real Time and Embedded systems
Object-oriented role analysis and modeling – Modeling method
Process Specification Language – Set of logic terms used to describe processes
Systems Modeling Language – General-purpose modeling languagePages displaying short descriptions of redirect targets
...
Chonoles, Michael Jesse; Schardt, James A. (2003). UML 2 for Dummies. Wiley Publishing. ISBN 0-7645-2614-6.
...
Jacobson, Ivar; Booch, Grady; Rumbaugh, James (1998). The Unified Software Development Process. Addison Wesley Longman. ISBN 0-201-57169-2.
Martin, Robert Cecil (2003). UML for Java Programmers. Prentice Hall. ISBN 0-13-142848-9.
Noran, Ovidiu S. "Business Modelling: UML vs. IDEF" (PDF). Archived from the original (PDF) on 18 July 2024. Retrieved 14 November 2022.
Kargl, Horst. "Interactive UML Metamodel with additional Examples".
Penker, Magnus; Eriksson, Hans-Erik (2000). Business Modeling with UML. John Wiley & Sons. ISBN 0-471-29551-5.
...
Official website 
Current UML specification: Unified Modeling Language 2.5.1. OMG Document Number formal/5 December 2017. Object Management Group Standards Development Organization (OMG SDO). December 2017.
