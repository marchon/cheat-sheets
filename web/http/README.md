...
Source: [https://www.cheat-sheets.org/#HTTP](https://www.cheat-sheets.org/#HTTP).
...
- Live: [https://en.wikipedia.org/wiki/Http](https://en.wikipedia.org/wiki/Http)
- Local clone: [wikipedia.md](wikipedia.md)

## Saved copies

- [http-response-codes-1.pdf](saved-copy/http-response-codes-1.pdf) — `https://www.cheat-sheets.org/saved-copy/http-response-codes-1.pdf`

## Cheat sheets

- HTTP/1.1 Status Codes by Bryan English [html] (bluelinecity.com) ([saved](https://www.cheat-sheets.org/saved-copy/http-response-codes-1.pdf))
