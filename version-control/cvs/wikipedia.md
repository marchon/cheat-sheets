...
Cloned from https://en.wikipedia.org/wiki/Concurrent_Versions_System.
...
== Portability ==
The developers of the server software write it for Unix, although CVSNT server also supports various versions of Microsoft Windows, while CVS clients may run on any major operating system platform.
