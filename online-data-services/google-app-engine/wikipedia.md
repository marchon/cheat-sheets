...
Cloned from https://en.wikipedia.org/wiki/Google_App_Engine.
...
Developers worry that the applications will not be portable from App Engine and fear being locked into the technology. In response, there are a number of projects to create open-source back-ends for the various proprietary/closed APIs of the app engine, especially the datastore.
AppScale automatically deploys and scales unmodified Google App Engine applications over popular public and private cloud systems and on-premises clusters. It can run Python, Java, PHP, and Go applications on EC2, Google Compute Engine, Azure, and other cloud vendors.
...
Benefits of adopting Google App Engine Archived February 2, 2017, at the Wayback Machine
Using an external database with Google App Engine Archived August 6, 2017, at the Wayback Machine
