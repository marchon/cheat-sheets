...
Cloned from https://en.wikipedia.org/wiki/Google_Maps.

Wikipedia text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

Page id: 1494648.

Google Maps is a web mapping platform and consumer application developed by Google. It offers satellite imagery, aerial photography, street maps, 360° interactive panoramic views of streets (Street View), real-time traffic conditions, and route planning for traveling by foot, car, bike, and public transportation. As of 2020, Google Maps was being used by over one billion people every month around the world.
...
On January 29, 2013, Google Maps was updated to include a map of North Korea. As of May 3, 2013, Google Maps recognizes Palestine as a country, instead of redirecting to the Palestinian territories.
...
On October 17, 2019, Google Maps was updated to include incident reporting, resembling a functionality in Waze, which had been acquired by Google in 2013.
...
In February 2026, South Korea allowed Google to export map data at 1:5,000-scale under security conditions after attempts in 2007, 2016, and 2025. The government compromised on its previous demands, finally allowing more detailed navigation to be included after the conditions were met.
...
Google Maps supports Open Location Codes, referred to as Plus Codes. These codes identify a position in the same way as coordinates, in a simplified format. They are of particular use for positions that do not have a street address. For example, the Merlion fountain in Singapore has coordinates 1.286785°N 103.854503°E﻿ / 1.286785; 103.854503; its Plus Code is 6PH57VP3+PR6, 7VP3+PR6 Singapore, or 7VP3+PR6 if in Singapore. Google Maps can display the code for a point on the map, and entering a Plus Code shows the location. Similar functionality is provided by the what3words system, for which the Merlion Fountain is at location sundry.simplistic.priorities.
...
Google.cn/maps does not provide My Maps. On the other hand, while google.cn displays virtually all text in Chinese, google.com/maps displays most text (user-selectable real text as well as those on map) in English. This behavior of displaying English text is not consistent but intermittent – sometimes it is in English, sometimes it is in Chinese. The criteria for choosing which language is displayed are not known publicly.
...
Google Maps was found accountable for redirecting the pair to the abandoned road, part of a 200 km shorter route than the normal one between Yakutsk and Magadan, the start and end point of the two.


=== Labelling disputes ===
Google Maps has been criticized for not labeling Palestine as a country. When users search for "Palestine", the name is not visible as a labeled entity on the map, while its neighboring states are shown. In 2016, in response to an accusation that it deleted Palestine from the maps, the company explained that they have never labelled Palestine on their maps and also that a temporary "bug" had removed the labels for the West Bank and the Gaza Strip. Google also claimed the reason they do not label Palestine is due to the territory and its boundaries still being disputed. However, critics have pointed out that Google Maps shows the Western Sahara, despite that territory also being part of a long-running dispute, and argued that Google demonstrates an inconsistent approach to disputed territories. Despite Google's explanation, backlash continued over the omission and in 2020, the controversy led to a Change.org petition to prompt Google to add Palestine to Google Maps, which has over 2.1 million signatures.
...
In late August 2026, after Donald Trump signed an executive order that renamed Lake Ontario to Lake America, Google Maps updated its base map data for users in the United States to reflect the name change. Maps still shows the lake as Lake Ontario for Canadian users, while showing both names for international users not based in either the US or Canada.


=== Border disputes ===
The Morocco-Western Sahara border exists as a disputed border between Morocco, which claims the territory of Western Sahara and the Polisario Front which claims the territory as an independent nation.  On November 1, 2025, users believed that the dotted border denoting that the border was disputed for users in Morocco. However, Google Maps released a statement that the disputed border had not been removed in late 2025, but had never been visually displayed to users within Morocco.
In 1791 and 1792, surveyors placed boundary stones every mile to demarcate the borders of Washington, D.C., many of which are still preserved.  Just inside the borders as demarcated by the  boundary stones are three roads, Western Avenue in the northwest, Eastern Avenue in the northeast, and Southern Avenue in the southeast, with the right-of-ways of these roads entirely within Washington, DC. Google Maps does not draw the borders of Washington, DC, through the boundary stones, which are the official border of Washington, DC, but rather through the centerline of the three roads.  This creates challenges with obtaining services, including emergency service, trash pickup, and road maintenance since, even resulting in political bodies calling out the circumstances.
...
=== Features ===
The Google Maps apps for iOS and Android have many of the same features, including turn-by-turn navigation, street view, and public transit information. Turn-by-turn navigation was originally announced by Google as a separate beta testing app exclusive to Android 2.0 devices in October 2009. The original standalone iOS version did not support the iPad, but tablet support was added with version 2.0 in July 2013. An update in June 2012 for Android devices added support for offline access to downloaded maps of certain regions, a feature that was eventually released for iOS devices, and made more robust on Android, in May 2014. Google Maps is getting a new Gemini upgrade that has hands-free, that is not available in Google Assistant. It makes navigating easier and smarter. Its required version is iOS 15 or Android 9 "Pie" for integration.
