...
Cheat-sheets.org topic in the Online data services group.

Source: [https://www.cheat-sheets.org/#CloudComputing](https://www.cheat-sheets.org/#CloudComputing).
...
- Live: [https://en.wikipedia.org/wiki/Cloud_Computing](https://en.wikipedia.org/wiki/Cloud_Computing)
...
- Getting Started with Cloud Computing by Daniel Rubio [html] (dzone.com) ([online](https://dzone.com/refcardz/getting-started-cloud))

## See also

- Google App Engine (`#GoogleAppEngine`)
- Scalability and High Availability (`#ScalabilityHighAvailability`)
- Windows Azure (`#Azure`)
