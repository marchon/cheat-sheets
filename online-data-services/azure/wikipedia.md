...
Cloned from https://en.wikipedia.org/wiki/Microsoft_Azure.
...
== Issues ==
Microsoft Azure's services can have varied and complex pricing models. Technical writers have noted that the Azure Portal layout can cause slow navigation and user error if complex configurations are mismanaged.
