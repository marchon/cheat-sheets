...
Cloned from https://en.wikipedia.org/wiki/Amazon_Web_Services.
...
Amazon markets AWS to subscribers as a way of obtaining large-scale computing capacity more quickly and cheaply than building an actual physical server farm. All services are billed based on usage, but each service measures usage in varying ways. As of 2023 Q1, AWS has 31% market share for cloud infrastructure while the next two competitors Microsoft Azure and Google Cloud have 25%, and 11% respectively, according to Synergy Research Group. AWS was the first cloud provider to build infrastructure specifically for U.S. government with respect to security and compliance requirements (2011;  launched AWS GovCloud), accredited to support classified workloads (2014; launched AWS Top Secret), and achieve accreditation across all U.S. government data classifications (2017; launched AWS Secret).
...
In October 2004, Amazon released Alexa Web Information Service (AWIS) as beta. In November 2004, AWS launched its first infrastructure service, as beta: Simple Queue Service (SQS)., and officially launched in July 2006.


=== S3, EC2, and other first-generation services (2006–2010) ===

On March 14, 2006, AWS launched Amazon S3 cloud storage, and that was the first AWS' IaaS that was generally available, followed by EC2 in August 2006. Pi Corporation, a startup Paul Maritz co-founded, was the first beta-user of EC2 outside of Amazon, while Microsoft was among EC2's first enterprise customers. Later that year SmugMug, one of the early AWS adopters, attributed savings of around US$400,000 in storage costs to S3. According to Vogels, S3 was built with 8 microservices when it launched in 2006 and had over 300 microservices by 2022.
...
In October 2014, Amazon Aurora was launched.
...
In November 2018, AWS announced customized ARM cores for use in its servers. Also in November 2018, AWS announced AWS Ground Stations to communicate with customers' satellites.
...
In February 2026, India's National Informatics Centre (NIC), a department under the Ministry of Electronics and Information Technology, announced deployment of AWS Outposts within its data centers as part of the government's Meghraj 2.0 hybrid cloud initiative, working with Indian data center provider Yotta Data Services. The deployment enables sensitive government workloads to remain within NIC's physical infrastructure while accessing AWS cloud services including Amazon EKS, Amazon RDS, and Amazon S3.
...
On 30 June 2026, AWS Secret Cloud for Industry (ASCI) was made generally available. It holds a Provisional Authorization at Impact Level 6 from the Defense Information Systems Agency and uses the same Defense Counterintelligence and Security Agency (DCSA) compliance framework that cleared defense contractors already use for on-premises classified systems. Northrop Grumman was the first defense contractor to deploy classified workloads on ASCI. To speed up the migration and to attract customers AWS launched ASCI Accelerator Initiative. The U.S. Intelligence Community (IC) launched IC Accelerated Modernization Framework (ICAMF) which subsidizes transfer to AWS from on-site systems. ASCI provides physically and logically isolated environment purpose-built to meet the most demanding security and compliance requirements. They also created AWS Forward Deployed Engineering (FDE) organization. It embeds AWS frontier teams—working with purpose-built agents—directly inside customer teams (business, engineering, and security teams) to build and deploy production AI systems with their data, governance, and processes.
...
Tim Bray – Canadian software developer (born 1955)
