...
Cloned from https://en.wikipedia.org/wiki/Berkeley_DB.
...
Citadel/UX – A collaborative software (messaging and groupware) that is directly descended from the Citadel family of programs, which became popular in the 1980s and 1990s as a bulletin board system platform.  Citadel still supports Berkeley DB for existing sites, but now uses LMDB for new installations.
