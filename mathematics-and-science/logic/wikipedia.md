...
Cloned from https://en.wikipedia.org/wiki/Logic.
...
Modal logic is an extension of classical logic. In its original form, sometimes called "alethic modal logic", it introduces two new symbols: 
 ...
 articulates the sentence "It is possible that Socrates is a banker". To include these symbols in the logical formalism, modal logic introduces new axioms and rules of inference that govern their use. One principle adopted in many systems, though not in the basic system K, states that, if something is necessary, then it is also possible. This means that 
...
. The two operators are also related by duality: if a proposition is necessary, then its negation is impossible, and vice versa. This means that 
