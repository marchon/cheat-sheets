...
Cloned from https://en.wikipedia.org/wiki/Google_Chrome.

Wikipedia text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

Page id: 19133401.

Google Chrome is a cross-platform web browser developed by Google. It was launched in September 2008 for Microsoft Windows and was built with free software components from Apple WebKit and Mozilla Firefox. Versions for Linux, macOS, iOS, iPadOS, and Android were later released, becoming the default browser on Android devices. The browser is also the main component of ChromeOS, on which it serves as the platform for web applications.
Most of Chrome's source code comes from Google's free and open-source software project known as Chromium, but Chrome is licensed as a proprietary freeware. WebKit was the original rendering engine for chrome, but Google eventually forked it to create the Blink engine; every version of Chrome uses Blink as of 2017, except for the version on IOS. 
As of March 2026, StatCounter estimates that Chrome has a 75.23% worldwide browser market share on personal computers. It is the most used browser on tablets having an estimated 48% market share. Chrome is also dominant on smartphones with around 67% market share. With a market share of 71.22% across all platforms combined as of December 2025, Chrome is the most used web browser in the world. Chrome has approximately 3.62 billion users as of March 2026.
...
In August 2020, Google transitioned Chrome for Android to a 64-bit architecture starting with Chrome 85 for supported high-end mobile devices to improve performance. In 2022, Chrome 104 introduced enhanced integration with the broader Android operating system, debuting partial custom tabs to allow multi-tasking alongside native apps. Google expanded its Privacy Sandbox initiative to Chrome for Android in February 2023 with the release of Chrome 110, testing on-device privacy APIs to replace cross-app tracking. Following these infrastructure shifts, Chrome began deploying localized, compressed small language models, allowing the browser to execute Gemini Nano on-device AI operations entirely offline via the experimental "window.ai" API.
...
Starting with Google Chrome 4.1, the application added a built-in translation bar using Google Translate. Language translation is currently available for 52 languages. When Chrome detects a foreign language other than the user's preferred language set during the installation time, it asks the user whether to translate.
...
Chrome formerly used their now-deprecated SPDY protocol instead of only HTTP when communicating with servers that support it, such as Google services, Facebook, and Twitter. SPDY support was removed in Chrome version 51. This was due to SPDY being replaced by HTTP/2, a standard that was based upon it.
...
In March 2021, Google announced that starting with Chrome 94 in the third quarter of 2021, Google Chrome Stable releases would be made every four weeks, instead of six weeks as they had been since 2010. Also, Google announced a new release channel for system administrators and browser embedders with releases every eight weeks. Five years later, it was announced that Chrome would follow Firefox in moving to its two-week development schedule, with the upcoming release of Chrome 153 on September 8.
...
=== macOS ===
Google dropped support for Mac OS X Leopard with the release of Chrome 22. Support for 32-bit versions of Chrome ended in November 2014 with the release of Chrome 39. Support for Mac OS X Snow Leopard, OS X Lion, and OS X Mountain Lion ended in April 2016 with the release of Chrome 50. Support for OS X Mavericks ended in April 2018 with the release of Chrome 66. Support for OS X Yosemite ended in January 2021 with the release of Chrome 88. Support for OS X El Capitan and macOS Sierra ended in August 2022 with the release of Chrome 104. Support for macOS High Sierra and macOS Mojave ended in September 2023 with the release of Chrome 117. Support for macOS Catalina ended in September 2024 with the release of Chrome 129. Support for macOS Big Sur ended in August 2025 with the release of Chrome 139. Support for macOS Monterey ended in July 2026 with the release of Chrome 151.
...
In 2026, Chrome released an update that installed Google Gemini Nano AI —a 4GB local AI model— onto users' hard drives without notifying them. The update, which targeted an unspecified number of desktop Chrome devices, has been criticized by users and analysts for its lack of transparency regarding privacy, user rights, and environmental impact.
...
Chrome overtook Firefox in November 2011 in worldwide usage. As of January 2026, according to StatCounter, Google Chrome had 71% worldwide global usage share, and, according to Cloudflare, it was 68%, making it the most widely used web browser.
