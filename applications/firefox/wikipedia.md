...
Cloned from https://en.wikipedia.org/wiki/Firefox.
...
ChromeOS is technically a Linux distribution, but it is so significant that it is listed anyway. Regardless, you can get Firefox on ChromeOS through the Google Play Store, by opening the terminal and typing Linux commands, or downloading a .deb file and loading Firefox.
