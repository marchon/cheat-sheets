...
Freeware software is available for use without charge and typically has limited functionality with a more capable version available commercially or as shareware. It is typically fully functional for an unlimited period of time.
...
Shareware permits redistribution, but the license only allows limited use before paying the license fee. Some features may be disabled prior to payment, in which case it is sometimes known as crippleware.
...
perceived risk
A potential customer may also use a free trial if they receive a forced free trial of a publication they didn’t request.
