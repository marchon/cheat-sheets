...
Cloned from https://en.wikipedia.org/wiki/Python_(programming_language).
...
RustPython is an implementation written in Rust language. It aims to be compatible with CPython, including its C-ABI.
