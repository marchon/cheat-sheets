...
Cloned from https://en.wikipedia.org/wiki/XML_schema.
...
RELAX NG has no ability to apply default attribute data to an element's list of attributes (i.e., changing the XML info set), while W3C XML Schema does. Again, this design is intentional and is to separate validation and augmentation.
...
March 2009 DEVX article "Taking XML Validation to the Next Level: Introducing CAM" by Michael Sorens Archived 2012-03-16 at the Wayback Machine
