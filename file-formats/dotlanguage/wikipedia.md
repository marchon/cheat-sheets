...
Cloned from https://en.wikipedia.org/wiki/DOT_(graph_description_language).
...
Delineate – a Rust application for Linux that can edit fully-featured DOT graph with interactive preview, and export as PNG, SVG, or JPEG
