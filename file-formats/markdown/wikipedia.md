...
Cloned from https://en.wikipedia.org/wiki/Markdown.
...
RFC 7763 – "The text/markdown Media Type," Informational. 
RFC 7764 – "Guidance on Markdown: Design Philosophies, Stability Strategies, and Select Registrations," Informational. 
...
== Further reading ==
Wilburn, Gene (12 January 2022). Markdown for Writers (2nd, revised ed.). Gene Wilburn. ISBN 978-1-895934-15-1.


== External links ==
Official website for original John Gruber markup
"Docling". docling.ai., converts messy documents — PDFs, Office files, HTML, images and audio — to structured Markdown
"Datalab Playground". www.datalab.to., conversion tool
