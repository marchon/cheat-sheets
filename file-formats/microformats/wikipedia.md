...
Cloned from https://en.wikipedia.org/wiki/Microformat.
...
As of 2026, microformats continue to be supported by modern web browsers and search engines as part of structured data processing on web pages. However, their usage has declined in favor of more recent standards such as JSON-LD and Schema.org, which provide greater flexibility for expressing structured information.
Despite this, microformats remain in use in legacy systems and are still recognized by parsers for extracting semantic information from HTML content. They continue to be referenced in various web specifications and contribute to machine-readable data extraction in HTML documents.
...
=== Accessibility ===
Because some microformats make use of title attribute of HTML's <abbr> element to conceal machine-readable data (particularly date-times and geographical coordinates) in the "abbr design pattern", the plain text content of the element is inaccessible to screen readers that expand abbreviations. In June 2008 the BBC announced that it would be dropping use of microformats using the abbr design pattern because of accessibility concerns.
...
One advocate of microformats, Tantek Çelik, characterized a problem with alternative approaches: Here's a new language we want you to learn, and now you need to output these additional files on your server. It's a hassle. (Microformats) lower the barrier to entry.
...
Another advocate of microformats, Ryan King, put the compatibility of microformats with other approaches this way: Microformats provide an easy way for many people to contribute semantic data to the web. With GRDDL all of that data is made available for RDF Semantic Web tools. Microformats and GRDDL can work together to build a better web.
...
== Further reading ==
Suda, Brian (September 2006). Using Microformats. O'Reilly Media. p. 45. ISBN 978-0-596-52821-8.
