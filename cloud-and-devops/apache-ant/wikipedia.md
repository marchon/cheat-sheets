...
Cloned from https://en.wikipedia.org/wiki/Apache_Ant.
...
This Ant task has the same name as the common Java command-line utility, JAR, but it uses Ant's built-in JAR/ZIP file support.
...
Gradle, a JVM build tool built with Java
