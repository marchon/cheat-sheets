...
Cloned from https://en.wikipedia.org/wiki/OpenCV.
...
A Compute Unified Device Architecture (CUDA) based graphics processing unit (GPU) interface has been in progress since September 2010.
...
Dlib – open-source machine learning and computer vision library written in C++
List of free and open-source software packages
List of robotics software
MediaPipe – open-source framework from Google
Open-source artificial intelligence
OpenNN – artificial neural network library written in C++
Point Cloud Library – library for point cloud processing
Robot Operating System (ROS) – uses OpenCV as its primary computer vision package
