...
Cloned from https://en.wikipedia.org/wiki/Qt_Creator.
...
== Debuggers ==
Qt Creator uses external native debuggers to debug the C++ language. Qt Creator displays the raw information provided by the native debuggers in a simplified manner.
